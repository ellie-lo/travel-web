...
export class ActivityComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.params.subscribe((data: any) => {
      ...
      this.datacity.getActivityCity(this.EncityName, 0).subscribe((value: any) => {
  ...
  checkPrev(page: number) {
    ...
    console.log(this.MaxPage);
    this.prevArray = this.getPrev(this.index, this.MaxPage);
    this.datacity.getActivityCity(this.EncityName, 9, (this.index - 1) * 9).subscribe((value: any) => {
      console.log(value);
