...
@Component({
  selector: 'app-ScenicSpot',
  templateUrl: './ScenicSpot.component.html',
  styleUrls: ['./ScenicSpot.component.scss']
})
export class ScenicSpotComponent implements OnInit {
  placeName: string = '';
  datavalue: Array<any> = [];
  cityName = '';
  EncityName = '';
  ...
  constructor(private route: ActivatedRoute, private datacity: CitydataService,private router: Router,public loader: LoadingService) { }
  ...
  ngOnInit() {
    this.route.params.subscribe((data: any) => {
      ...
      this.datacity.getScenicSpotCity(this.EncityName, 9).subscribe((value: any) => {
  ...
  checkPrev(page: number) {
    this.index = page;
    this.datacity.getScenicSpotCity(this.EncityName, 9, (this.index - 1) * 9).subscribe((value: any) => {
      console.log(value);
